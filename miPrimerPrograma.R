#Creamos aqui nuestro primer objeto numerico llamado a:
a=5

# Ahora creamos un objeto llamado aModificado que multiplique por 2
...
# de una varaible gaussianamente (normalmente) distribuida con media de 0
